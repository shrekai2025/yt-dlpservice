  ...
  'kie-veo3-1': [
    {
      ...
      helperText: 'veo3质量更高但费用较高且速度较慢，veo3_fast速度更快费用较低',
    },
    {
      key: 'generationType',
      label: '生成模式',
      ...
      options: [
        { label: 'TEXT_2_VIDEO (文生视频)', value: 'TEXT_2_VIDEO' },
        { label: 'FIRST_AND_LAST_FRAMES_2_VIDEO (首尾帧)', value: 'FIRST_AND_LAST_FRAMES_2_VIDEO' },
        { label: 'REFERENCE_2_VIDEO (参考图)', value: 'REFERENCE_2_VIDEO' },
      ],
      helperText: '文生视频:仅用文本生成; 首尾帧:1张图或2张图(首帧+尾帧); 参考图:1-3张参考图(仅支持veo3_fast+16:9)',
    },
    {
      key: 'aspectRatio',
      label: '画面比例',
      ...
      helperText: '只有16:9支持1080P高清视频。REFERENCE_2_VIDEO模式仅支持16:9',
    },
    {
      key: 'seeds',
      label: '随机种子',
      ...
      max: 99999,
      step: 1,
      placeholder: '10000-99999 (可选)',
      helperText: '可选。相同种子生成相似内容,不同种子生成不同内容。留空则自动分配',
    },
    {
      key: 'enableTranslation',
      label: '启用提示词翻译',
      type: 'boolean',
      defaultValue: true,
      helperText: '开启后将非英文提示词自动翻译为英文以获得更好效果',
    },
    {
      key: 'watermark',
      label: '水印文字',
      ...
      helperText: '可选。在生成的视频中添加自定义水印文字',
    },
    {
      key: 'callBackUrl',
      label: '回调通知 URL',
      ...
      helperText: '可选。任务完成时系统将向此URL发送POST请求通知结果',
    },
  ],
