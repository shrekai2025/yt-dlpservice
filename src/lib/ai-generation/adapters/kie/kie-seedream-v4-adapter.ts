/**
 * KieSeedreamV4Adapter - Kie.ai Seedream V4 Text To Image
 *
 * 对应模型: bytedance/seedream-v4-text-to-image
 * 功能: 文生图
 */
...
export class KieSeedreamV4Adapter extends BaseAdapter {
  /**
  ...
  async dispatch(request: GenerationRequest): Promise<AdapterResponse> {
    try {
      ...
      this.log('info', 'Creating Kie Seedream V4 task', payload)
      ...
      this.log('error', 'Kie Seedream V4 dispatch failed', error)
